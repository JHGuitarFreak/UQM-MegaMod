...
VOL_SPACE="mm-$PKG_VERSION-volasaurus-space-music.uqm"
RMX_UTWIG="mm-$PKG_VERSION-rmx-utwig.uqm"
MEL_FIX="mm-$PKG_VERSION-MelnormeVoiceFix.uqm"
SYR_FIX="mm-$PKG_VERSION-SyreenVoiceFix.uqm"

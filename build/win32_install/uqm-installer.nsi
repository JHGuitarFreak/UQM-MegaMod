...
!include "dlls.nsi"
    ...
    # Delete old content
    Delete "$INSTDIR\content\addons\uqm-0.7.0-3DOMusicRemastered.uqm"
    Delete "$INSTDIR\content\addons\uqm-0.7.0-3dovideo.uqm"
    Delete "$INSTDIR\content\addons\uqm-0.8.0-3dovoice.uqm"
    Delete "$INSTDIR\content\packages\mm-0.8.0-content.uqm"
    Delete "$INSTDIR\content\packages\mm-0.8.0.85-content.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.0.85-hd.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.0.85-vol-space.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.0.85-vols-remix.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.0.85-tarps-choice.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.0.85-sol-textures.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.0.85-rmx-utwig.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.0.85-remix-timing.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.0.85-classic-hd-fonts.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.0.85-3dovoice.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.0.85-yellow-fried.uqm"
    Delete "$INSTDIR\content\packages\mm-0.8.1-content.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.1-hd.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.1-vols-remix.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.1-sol-textures.uqm"
    Delete "$INSTDIR\content\addons\mm-0.8.1-3dovoice.uqm"

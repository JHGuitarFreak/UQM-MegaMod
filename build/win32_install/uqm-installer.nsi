...
Unicode True
BrandingText "We did. You did. Yes we can. No."
...
!define MAINFILENAME "UrQuanMasters"
...
; Directory page
!define MUI_PAGE_CUSTOMFUNCTION_LEAVE "CheckInstDirOnLeave"
...
OutFile "mm-${PRODUCT_VERSION}${INSTALLER_VERSION}-installer.exe"
...
Var IS_EXISTING_INST

Function CheckForExistingInst
  StrCpy $IS_EXISTING_INST "FALSE"

  ${If} ${FileExists} "$INSTDIR\uqm.exe"
    StrCpy $IS_EXISTING_INST "TRUE"
  ${EndIf}

  ${If} ${FileExists} "$INSTDIR\uqmdebug.exe"
    StrCpy $IS_EXISTING_INST "TRUE"
  ${EndIf}
FunctionEnd

Function CheckInstDirOnLeave
  Call CheckForExistingInst
  ${If} $IS_EXISTING_INST == "TRUE"
    MessageBox MB_ICONSTOP|MB_OK "MegaMod is not compatible with other installations of The Ur-Quan Masters.$\r$\n$\r$\nThe selected folder already contains a UQM installation (uqm.exe or uqmdebug.exe found). If you were to install MegaMod here then MegaMod files would combine with the existing UQM installation, which can cause:$\r$\n$\r$\n- Content conflicts between standard UQM and MegaMod packages$\r$\n- Game-breaking bugs during gameplay$\r$\n- Crashes or unexpected behavior$\r$\n$\r$\nMegaMod requires either a clean, dedicated installation folder or an existing MegaMod folder to function properly.$\r$\n$\r$\nYou need to install MegaMod in a different directory than the one just chosen."
    Abort
  ${EndIf}
FunctionEnd
...
Function RemoveOldFiles
  ...
  ${RemoveFileFromRoot} "content\addons\uqm-0.8.0-voice.uqm"
  ${RemoveFileFromRoot} "content\addons\uqm-0.8.0-3domusic.uqm"
  ...
  # v0.8.3 content
  ${RemoveFileFromRoot} "content\packages\mm-0.8.3-content.uqm"
  ${RemoveFileFromRoot} "content\addons\mm-0.8.3-hd-content.uqm"
  ${RemoveFileFromRoot} "content\addons\mm-0.8.3-3dovoice.uqm"
  ${RemoveFileFromRoot} "content\addons\mm-0.8.3-hd-classic-pack.uqm"
  ${RemoveFileFromRoot} "content\addons\mm-0.8.3-volasaurus-remix-pack.uqm"
  ${RemoveFileFromRoot} "content\addons\mm-0.8.3-3domode.uqm"
  ${RemoveFileFromRoot} "content\addons\mm-0.8.3-dosmode.uqm"
  ${RemoveFileFromRoot} "content\addons\mm-rmx-utwig.uqm"
  ${RemoveFileFromRoot} "content\addons\MelnormeVoiceFixMMAddon.uqm"
  ${RemoveFileFromRoot} "content\addons\SyreenVoiceFixMMAddon.uqm"
  # v0.8.4 content
  ${RemoveFileFromRoot} "content\packages\mm-0.8.4-content.uqm"
  ${RemoveFileFromRoot} "content\addons\mm-0.8.4-hd-content.uqm"
  ${RemoveFileFromRoot} "content\addons\mm-0.8.4-hd-classic-pack.uqm"
  ${RemoveFileFromRoot} "content\addons\mm-0.8.4-3domode.uqm"
  ${RemoveFileFromRoot} "content\addons\mm-0.8.4-dosmode.uqm"
FunctionEnd
...
!include "dlls.nsi"
    ...
    File "..\..\content\gamecontrollerdb.txt"

    SetOutPath "$INSTDIR\content\packages"
    SetOverwrite ifnewer
    AddSize ${PKG_CONTENT_SIZE}
    File "${PKG_CONTENT_FILE}"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SECGRP01} "The core executables and main content libraries for The Ur-Quan Masters MegaMod."
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "Includes the main program, all subsidiary libraries, basic documentation, and the main content package"

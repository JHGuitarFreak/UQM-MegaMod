...
# Visuals
      ...
      NPC Ship Facing - Turn on/off whether NPC ships face their direction of travel.
...
# Music
    ...
    SOI Space Music - This option can turn on or off music that plays when inside the Sphere of Influence (while in a solar system) of an alien race.
                        You need to either download just Volasaurus' SOI music or Volasaurus' entire remix package to be able to enable this in game.

# Controls

    Control Display - Change the on-screen control display between Keyboard, Xbox, or Playstation 4 controls.
                      Also switches the control scheme to make the DualShock4 fully usable in menus when selected.
                      Requires a restart of the game after changing.
...
# Advanced
    ...
    Difficulty - Toggles between Normal, Easy, and Hard difficulties. 
                  The differences are as follows:
                    ...
                    # Hard Mode
                      ...
                      - The natural QuasiSpace portal is delayed by one year
    ...
    Tutorial Graphics - Enables/disables on-screen helpers for mineral worth while landing and StarMap keys while on the StarMap
...
#define BRIGHT_PINK_COLOR \
		BUILD_COLOR (MAKE_RGB15 (0x1F, 0x00, 0x1F), 0xFF)
#define TEAL_COLOR BUILD_COLOR (MAKE_RGB15 (0x00, 0x1F, 0x1F), 0xFF)
#define VDKGRAYB_COLOR \
		BUILD_COLOR (MAKE_RGB15 (0x06, 0x0B, 0x0B), 0x00)
/* end uqm-hd */
...
#define WIDGET_NET_MELEE_BACKGROUND \
		BUILD_COLOR_RGB (0x00, 0x00, 0x2A)

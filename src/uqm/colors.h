...
#define DARKMODE_FG_TABLE \
		{ \
			BUILD_COLOR_RGBA(0x00, 0xFF, 0x10, 0x00), \
			BUILD_COLOR_RGBA(0x00, 0xFF, 0x20, 0x00), \
			BUILD_COLOR_RGBA(0x00, 0xFF, 0x30, 0x00), \
			BUILD_COLOR_RGBA(0x00, 0xFF, 0x40, 0x00), \
			BUILD_COLOR_RGBA(0x00, 0xFF, 0x50, 0x00), \
			BUILD_COLOR_RGBA(0x00, 0xFF, 0x60, 0x00), \
			BUILD_COLOR_RGBA(0x08, 0xFF, 0x70, 0x00), \
			BUILD_COLOR_RGBA(0x10, 0xFF, 0x80, 0x00), \
			BUILD_COLOR_RGBA(0x18, 0xFF, 0x90, 0x00), \
			BUILD_COLOR_RGBA(0x20, 0xFF, 0xA0, 0x00), \
			BUILD_COLOR_RGBA(0x28, 0xFF, 0xB0, 0x00), \
			BUILD_COLOR_RGBA(0x30, 0xFF, 0xC0, 0x00), \
			BUILD_COLOR_RGBA(0x38, 0xFF, 0xD0, 0x00), \
			BUILD_COLOR_RGBA(0x40, 0xFF, 0xE0, 0x00), \
			BUILD_COLOR_RGBA(0x48, 0xFF, 0xF0, 0x00), \
			BUILD_COLOR_RGBA(0x55, 0xFF, 0xFF, 0x00), \
		}

// Dark Mode FG text Color
#define DARKMODE_BG_TABLE \
		{ \
			BUILD_COLOR_RGBA(0xE0, 0x9A, 0x14, 0x00), \
			BUILD_COLOR_RGBA(0xD2, 0x87, 0x14, 0x00), \
			BUILD_COLOR_RGBA(0xC4, 0x7E, 0x14, 0x00), \
			BUILD_COLOR_RGBA(0xB6, 0x75, 0x14, 0x00), \
			BUILD_COLOR_RGBA(0xA8, 0x6C, 0x14, 0x00), \
			BUILD_COLOR_RGBA(0x9A, 0x63, 0x14, 0x00), \
			BUILD_COLOR_RGBA(0x8C, 0x5A, 0x14, 0x00), \
			BUILD_COLOR_RGBA(0x7E, 0x51, 0x14, 0x00), \
			BUILD_COLOR_RGBA(0x70, 0x48, 0x07, 0x00), \
			BUILD_COLOR_RGBA(0x62, 0x3F, 0x07, 0x00), \
			BUILD_COLOR_RGBA(0x54, 0x36, 0x07, 0x00), \
			BUILD_COLOR_RGBA(0x46, 0x2D, 0x00, 0x00), \
			BUILD_COLOR_RGBA(0x38, 0x24, 0x00, 0x00), \
			BUILD_COLOR_RGBA(0x2A, 0x1B, 0x00, 0x00), \
			BUILD_COLOR_RGBA(0x1C, 0x12, 0x00, 0x00), \

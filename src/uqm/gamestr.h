...
#define SHIP_DESC_STRING_COUNT   25
...
enum {
	...
	SHIP_DESC_STRING_BASE  = BIOLOGICAL_STRING_BASE + BIOLOGICAL_STRING_COUNT,

	GAMESTR_COUNT          = SHIP_DESC_STRING_BASE + SHIP_DESC_STRING_COUNT
};

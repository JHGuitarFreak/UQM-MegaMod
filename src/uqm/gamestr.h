...
#define MEGAMOD_STRING_COUNT     17
...
enum {
	...
	MEGAMOD_STRING_BASE    = BIOLOGICAL_STRING_BASE + BIOLOGICAL_STRING_COUNT,

	GAMESTR_COUNT          = MEGAMOD_STRING_BASE + MEGAMOD_STRING_COUNT
};

...
#define DOSMENU_STRING_COUNT     46
...
enum {
	...
	DOSMENU_STRING_BASE    = MAINMENU_STRING_BASE + MAINMENU_STRING_COUNT,
	NETMELEE_STRING_BASE   = DOSMENU_STRING_BASE + DOSMENU_STRING_COUNT,

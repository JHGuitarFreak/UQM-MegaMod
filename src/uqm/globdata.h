 ...
 * shouldn't be part of the serialized Game State array! --MCM */
	...
	ADD_GAME_STATE (SYS_RETICULE_00, 32)
	ADD_GAME_STATE (SYS_RETICULE_01, 32)
	ADD_GAME_STATE (SYS_RETICULE_02, 32)
	ADD_GAME_STATE (SYS_RETICULE_03, 32)
	ADD_GAME_STATE (SYS_RETICULE_04, 32)
	ADD_GAME_STATE (SYS_RETICULE_05, 32)
	ADD_GAME_STATE (SYS_RETICULE_06, 32)
	ADD_GAME_STATE (SYS_RETICULE_07, 32)
	ADD_GAME_STATE (SYS_RETICULE_08, 32)
	ADD_GAME_STATE (SYS_RETICULE_09, 32)
	ADD_GAME_STATE (SYS_RETICULE_10, 32)
	ADD_GAME_STATE (SYS_RETICULE_11, 32)
	ADD_GAME_STATE (SYS_RETICULE_12, 32)
	ADD_GAME_STATE (SYS_RETICULE_13, 32)
	ADD_GAME_STATE (SYS_RETICULE_14, 32)
	ADD_GAME_STATE (SYS_RETICULE_15, 32)

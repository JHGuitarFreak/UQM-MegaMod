...
{
	NAV_TAB_STR_BASE  = 0,
	GEN_SETT_STR_BASE = NAV_TAB_STR_BASE  + NAV_TAB_STR_COUNT,
	GEN_GFX_STR_BASE  = GEN_SETT_STR_BASE + GEN_SETT_STR_COUNT,
	GEN_ENG_STR_BASE  = GEN_GFX_STR_BASE  + GEN_GFX_STR_COUNT,
	TIP_WARN_STR_BASE = GEN_ENG_STR_BASE  + GEN_ENG_STR_COUNT,

	IMGUI_STR_COUNT   = TIP_WARN_STR_BASE + TIP_WARN_STR_COUNT
};

...
void draw_visual_menu (void)
{
	...
	ImGui_EndDisabled (); // HD Animations
	...
	UQM_ImGui_CheckBox (ImStr (ENH_VIS_STR_BASE + 12), &optNonStopOscill,
			"mm.nonStopOscill", false);
	...
	// Hazard Colors
	UQM_ImGui_CheckBox (ImStr (ENH_VIS_STR_BASE + 18), &optHazardColors,
			"mm.hazardColors", false);
	...
	UQM_ImGui_CheckBox (ImStr (ENH_VIS_STR_BASE + 20), &optShowUpgrades,
			"mm.showUpgrades", false);

...
#define UQM_MAP_HEIGHT PC_MAP_HEIGHT
#define ORIGINAL_MAP_WIDTH (optPlanetTexture ? UQM_MAP_WIDTH-1 : PC_MAP_WIDTH)
#define ORIGINAL_MAP_HEIGHT PC_MAP_HEIGHT
#define MAP_WIDTH RES_SCALE (UQM_MAP_WIDTH)
#define MAP_HEIGHT RES_SCALE (PC_MAP_HEIGHT)
...
#define THREEDO_ROTATION_RATE (ONE_SECOND * 5 / RES_SCALE (PC_MAP_WIDTH))

...
#define LAUNCH_YOFFS0 -DISPLAY_TO_WORLD (RES_BOOL(18, 63))
#define LAUNCH_XOFFS1 DISPLAY_TO_WORLD (RES_BOOL(13, 48))
#define LAUNCH_YOFFS1 -DISPLAY_TO_WORLD (RES_BOOL(9, 25))
#define LAUNCH_XOFFS2 DISPLAY_TO_WORLD (RES_BOOL(17, 64))
#define LAUNCH_YOFFS2 -DISPLAY_TO_WORLD (RES_BOOL(4, 11))
...
init_utwig (void)
{
	...
	if (IS_HD)
	{
		...
		utwig_desc.characteristics.thrust_increment =

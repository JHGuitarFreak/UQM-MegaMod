...
#define DRIVE_SIDE_X RES_SCALE(31) + IF_HD(89)
#define DRIVE_SIDE_Y RES_SCALE(56) - IF_HD(16)
#define DRIVE_TOP_X RES_SCALE(33) + IF_HD(81)
#define DRIVE_TOP_Y RES_SCALE(86) + IF_HD(32)

#define JET_SIDE_X RES_SCALE(71) + IF_HD(56)
#define JET_SIDE_Y RES_SCALE(48) + IF_HD(4)
#define JET_TOP_X RES_SCALE(70) + IF_HD(57)
#define JET_TOP_Y RES_SCALE(94) + IF_HD(22)

#define MODULE_SIDE_X RES_SCALE(17) + IF_HD(46)
#define MODULE_SIDE_Y RES_SCALE(14) - IF_HD(13)
#define MODULE_TOP_X RES_SCALE(17) + IF_HD(46)
#define MODULE_TOP_Y RES_SCALE(117) + IF_HD(1)

#define SHIP_PIECE_OFFSET RES_BOOL(12, 42)

...
#define DRIVE_TOP_X RES_SCALE(33) + IF_HD(100)
#define DRIVE_TOP_Y RES_SCALE(86) - IF_HD(73)

#define JET_SIDE_X RES_SCALE(71) 
#define JET_SIDE_Y RES_SCALE(48) 
#define JET_TOP_X RES_SCALE(70) + IF_HD(86)
#define JET_TOP_Y RES_SCALE(94) - IF_HD(120)

#define MODULE_SIDE_X RES_SCALE(17) + IF_HD(55)
#define MODULE_SIDE_Y RES_SCALE(14) - IF_HD(5)
#define MODULE_TOP_X RES_SCALE(17) + IF_HD(55)
#define MODULE_TOP_Y RES_SCALE(117) + IF_HD(59)

#define SHIP_PIECE_OFFSET RES_SCALE(12) - IF_HD(2)

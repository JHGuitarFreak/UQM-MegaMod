...
#define DRIVE_SIDE_Y RES_SCALE(56) - IF_HD(30)
#define DRIVE_TOP_X RES_SCALE(33) + IF_HD(81)
#define DRIVE_TOP_Y RES_SCALE(86) + IF_HD(23)

#define JET_SIDE_X RES_SCALE(71) + IF_HD(55)
#define JET_SIDE_Y RES_SCALE(48) - IF_HD(13)
#define JET_TOP_X RES_SCALE(70) + IF_HD(59)
#define JET_TOP_Y RES_SCALE(94) + IF_HD(19)

#define MODULE_SIDE_X RES_SCALE(17) + IF_HD(47)
#define MODULE_SIDE_Y RES_SCALE(14) - IF_HD(17)
#define MODULE_TOP_X RES_SCALE(17) + IF_HD(47)

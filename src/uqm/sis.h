...
{
	SPECIAL_BEVEL = 0,
	THICK_INNER_BEVEL = SPECIAL_BEVEL + 8,
	THIN_INNER_BEVEL = THICK_INNER_BEVEL + 8,
	THICK_OUTER_BEVEL = THIN_INNER_BEVEL + 8,
	THIN_OUTER_BEVEL = THICK_OUTER_BEVEL + 8,
	DOS_MENU_HILITE = THIN_OUTER_BEVEL + 8,
} BEVEL_LEVEL;
